...
public class MomoService : IMomoService
{
    ...
    private readonly string _paramUrlCallBack = "?payment_method=MoMo&payment_code={0}&success=1&order_id={1}";
    ...
    public async Task<ResponseUriModel> CreatePayment(PaymentInfoModel dto)
    {
        ...
        var returnUrl = urlCallBack + string.Format(_paramUrlCallBack, dto.PaymentCode, orderId);
